    ...
    <AuthLayout>
      <Row gutter={[16,16]} style={{ margin: '2rem'}}> 
        <Col span={14}>
          ...
          <Card title="Card Title 2" bordered={false} style={{ marginTop: '1rem' }}>
